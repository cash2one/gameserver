...
size_t IMultiByteToWideChar(UINT CodePage,uint32_t dwFlags,PSTR szMB,size_t nMB,PWSTR pwWC,size_t nWC);
size_t IWideCharToMultiByte(UINT CodePage,uint32_t dwFlags,PWSTR pwWC,size_t nWC,PSTR szMB,size_t nMB,LPCSTR lpDefaultChar,BOOL *lpUsedDefaultChar);
...
size_t MultiByteToWideChar(UINT CodePage,uint32_t dwFlags,PSTR szMB,size_t nMB,PWSTR pwWC,size_t nWC);
size_t WideCharToMultiByte(UINT CodePage,uint32_t dwFlags,PWSTR pwWC,size_t nWC,PSTR szMB,size_t nMB,LPCSTR lpDefaultChar,BOOL *lpUsedDefaultChar);
