...
bool zMTCPServer::bind(const std::string &name,const uint16_t port) 
{
	...
	Xlogger->info("服务器 %s:%u 端口初始化绑定成功",name.c_str(),port);
