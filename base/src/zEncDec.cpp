...
int CEncrypt::encdec_des(BYTE *data,uint32_t nLen,bool enc)
{
...
int CEncrypt::encdec_rc5(BYTE *data,uint32_t nLen,bool enc)
{
...
int CEncrypt::encdec(void *data,uint32_t nLen,bool enc)
{
  switch(method)
  {
    case ENCDEC_NONE:
